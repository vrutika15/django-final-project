...
#         project_form.fields["project"].queryset = ProjectReportForm.objects.filter(
#             pk=project.pk
#         )
#         if project_form.is_valid():
#             project_form.save()
...
#         project_form.fields["project"].queryset = Project.objects.filter(
#             pk=project.project.pk
#         )

#     return render(
#         request,
#         "attendance/edit_project_attendance.html",
#         {
#             "form": project_form,
...
#         "reports__project_profile", "reports__resources", "reports__poc"
#     )
...
#             assigned_projects_qs = (
#                 ProjectReport.objects.filter(
#                     Q(resources=selected_resource) | Q(poc=selected_resource)
#                 )
#                 .select_related("project", "project_profile")
#                 .prefetch_related("resources", "poc")
#                 .distinct()
#             )
...
#         resources_by_period.setdefault(
#             period_key,
#             {
#                 "year": year,
#                 "month": month,
